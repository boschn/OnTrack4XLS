...
Module modQuicknDirty
    ...
    '        flag = True
    '    Else
    '        Call CoreMessageHandler(showmsgbox:=True, break:=False, procedure:="modDoc9.getDBdDoc9Range", _
    ...
    Function getXLSHeaderIDColumn(ByVal headerid As String) As Integer
        ...
        '** errror handling
        If Not flag Then
            Call CoreMessageHandler(SHOWMSGBOX:=True, break:=False, procedure:="modDoc9.getXLSHeaderIDColumn", _
    ...
    Public Function getDBDescIDs() As Object()
        ...
        If headerids Is Nothing Then
            Call CoreMessageHandler(SHOWMSGBOX:=True, break:=False, procedure:="modDoc9.getDBDescIDs", _
    ...
    Optional aWorkbook As Excel.Workbook = Nothing) As Boolean
        ...
        ' error
        If headerids Is Nothing Then
            Call CoreMessageHandler(showmsgbox:=True, break:=False, procedure:="modDoc9.getDBDesc", _
                              message:="The parameter 'parameter_doc9_headerid_name':" & headerids_name & " is not showing a valid range !", _
                              messagetype:=otCoreMessageType.ApplicationError)
    ...
    Public Sub updateXlSDBDescTable(Optional aWorkbook As Excel.Workbook = Nothing)
        ...
        ' error
        If headerids Is Nothing Then
            Call CoreMessageHandler(SHOWMSGBOX:=True, break:=False, procedure:="modDoc9.updateXLSDBDescTable", _
                              message:="The parameter 'parameter_doc9_headerid_name':" & headerids_name & " is not showing a valid range !", _
                              messagetype:=otCoreMessageType.ApplicationError)
            Exit Sub
        End If
    ...
    '    If headerids Is Nothing Then
    '        If Not silent Then
    '            Call CoreMessageHandler(SHOWMSGBOX:=True, break:=False, procedure:="modDoc9.replicateWITHOTDB", _
    '                         message:="The parameter 'parameter_doc9_headerid_name':" & headerids_name & " is not showing a valid range !", _
    '                         messagetype:=otCoreMessageType.ApplicationError)
    '        End If
