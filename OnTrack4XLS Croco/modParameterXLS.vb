    ...
    Function GetXlsParameterRangeByName(ByVal name As String, _
            ...
            Else
                If Not silent Then
                    Call CoreMessageHandler(message:="The Worksheet " & constParameterSheetName & " is not found in this Workbook '" & wb.Name & "' !", _
                                                messagetype:=otCoreMessageType.ApplicationError, showmsgbox:=True, procedure:="modParameterXLS.getXLSParameterRangebyName")
                End If
            End If
        ...
        Catch ex As Exception
            Call CoreMessageHandler(exception:=ex, _
                                         messagetype:=otCoreMessageType.ApplicationError, procedure:="modParameterXLS.getXLSParameterRangebyName")
    ...
    Function SetXlsParameterValueByName(ByVal name As String, _
        ...
        Try
            ...
            Else
                If Not silent Then
                    Call CoreMessageHandler(message:="The Worksheet " & constParameterSheetName & " is not found in this Workbook '" & wb.Name & "' !", _
                                                   messagetype:=otCoreMessageType.ApplicationError, showmsgbox:=True, procedure:="modParameterXLS.SetXLSParameterValuebyName")
        ...
        Catch ex As Exception
            ...
            Call CoreMessageHandler(message:="The parameter '" & name & " ' cannot be written to " & wb.Name & "!", _
                                        procedure:="modParameterXLS.SetXlsParameterValueByName", argument:=name, showmsgbox:=silent)
            Call CoreMessageHandler(exception:=ex, messagetype:=otCoreMessageType.ApplicationException, _
                                         procedure:="modParameterXLS.SetXlsParameterValueByName", argument:=name)
            Return False
        End Try
    ...
    Function SetXlsParameterRangeByName(ByVal name As String, _
        ...
        Try
            ...
            Else
                If Not silent Then
                    Call CoreMessageHandler(message:="The Worksheet " & constParameterSheetName & " is not found in this Workbook '" & wb.Name & "' !", _
                                                   messagetype:=otCoreMessageType.ApplicationError, showmsgbox:=True, procedure:="modParameterXLS.SetXlsParameterRangeByName")
        ...
        Catch ex As Exception
            ...
            Call CoreMessageHandler(message:="The parameter '" & name & " ' cannot be written to " & wb.Name & "!", _
                                        procedure:="modParameterXLS.SetXlsParameterRangeByName", argument:=name, showmsgbox:=silent)
            Call CoreMessageHandler(exception:=ex, messagetype:=otCoreMessageType.ApplicationException, _
                                         procedure:="modParameterXLS.SetXlsParameterRangeByName", argument:=name)
            Return False
        End Try
